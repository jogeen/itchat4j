...
/**
 * 多用户登录发送消息的类
 * 将MessageTools的方法改写成非静态的。
 * 
 * @author www.jogeen.com
 * @date 2018年4月30日
 */
public class MultiMessageTools {
	private  Logger LOG = LoggerFactory.getLogger(MultiMessageTools.class);
	private MultiCore core;
	private MyHttpClient myHttpClient;

	public MultiMessageTools(MultiCore core) {
		this.core = core;
	...
	private  boolean webWxSendAppMsg(String userId, Map<String, String> data) {
		 ...
		 * baseRequestMap = (Map<String, Map<String, String>>) core.getLoginInfo()
		 * .get("baseRequest"); paramMap.put("BaseRequest",
