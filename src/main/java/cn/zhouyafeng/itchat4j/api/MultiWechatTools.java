...
/**
 * 微信小工具，如获好友列表等
 * 将WechatTools的方法改写成非静态的。方法的具體实现还是和WechatTools一致
 * 
 * @author www.jogeen.com
 * @date 2018年4月30日
 */
public class MultiWechatTools {
	private  Logger LOG = LoggerFactory.getLogger(MultiWechatTools.class);
	
	private MultiCore core;
	public MultiWechatTools(MultiCore core) {
		this.core = core;
	}
